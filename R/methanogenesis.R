...
init <- function(CH4.initial, K.CH4, H2.initial, K.H2,
                 ...
                 temperature, VolumeSolution, VolumeHeadspace, biomass_yield,carbon_fraction,K.CO2HCO3,K.HCO3CO3){
  ...
  #yield coefficients
  CH4.per.step <- CH4.coefficient(biomass_yield,carbon_fraction)
  H2.per.step <- H2.coefficient(biomass_yield,carbon_fraction)
...
#' @param carbon_fraction w/w percent C of biomass, expressed as a decimal. 0.44 by default.
